...
const bgcolor = Color.fromARGB(255, 64, 5, 90);
...
const color1 = Color.fromARGB(255, 252, 152, 53);
...
const text = TextStyle(color: Colors.black, fontWeight: FontWeight.bold);
const text3 = TextStyle(color: Color.fromARGB(255, 252, 152, 53), fontSize: 12);
const text4 =
...
const Textsty1 = TextStyle(fontWeight: FontWeight.bold, fontSize: 22);
